...
const STATUS_MAP: Record<string, number> = {
  ...
  PURCHASE_ORDER_NOT_FOUND: HttpStatus.NOT_FOUND,
  INVALID_ORDER_STATUS_TRANSITION: HttpStatus.BAD_REQUEST,
  INVALID_QUANTITY_FOR_ORDER: HttpStatus.BAD_REQUEST,
  ALERT_NOT_ACTIVE: HttpStatus.BAD_REQUEST,
  ALERT_ID_NOT_ALLOWED_FOR_MANUAL: HttpStatus.BAD_REQUEST,
};
